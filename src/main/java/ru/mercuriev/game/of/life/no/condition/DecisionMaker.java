...
public class DecisionMaker {
    ...
    private final static Class<Cell>[] NEXT_STATE_FOR_ALIVE = new Class[]{
    ...
    private final static Class<Cell>[] NEXT_STATE_FOR_DEAD = new Class[]{
            DeadCell.class, DeadCell.class, DeadCell.class,
            AliveCell.class, DeadCell.class, DeadCell.class,
            DeadCell.class, DeadCell.class, DeadCell.class};
    private final static Class<Cell>[][] NEXT_STATE = new Class[][]{NEXT_STATE_FOR_DEAD, NEXT_STATE_FOR_ALIVE};

    public static Cell nextGenerationCell(Cell c, int neighboursAmount) {
        try {
            int oldState = c.getState();
            Cell cell = NEXT_STATE[oldState][neighboursAmount].newInstance();
            cell.setX(c.getX());
            cell.setY(c.getY());
            return cell;
